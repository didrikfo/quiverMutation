...
def main(argv=None):
    ...
    parser.add_argument("--resume", action="store_true",
                        help="continue from an existing CSV instead of starting over. "
                             "Every step writes the table after every class and records "
                             "what it finished beside the CSV, so a run that was "
                             "interrupted picks up where it stopped rather than redoing "
                             "the naming and the resolving.")
    parser.add_argument("--budget-hours", type=float, default=None, dest="budget_hours",
